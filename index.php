...
<head>
 ...
 <title>jangomart - Login Demo</title>
</head>
<body>
<header>
 <nav>
  <ul>
   <li><a href="https://7topics.com">jangomart</a></li>
   <li><a href="https://7topics.com/creating-user-profile-page-using-php-and-mysql.html">Tutorial</a></li>
  </ul>
 </nav>
</header>
<div id="center">
<div id="center-set"> -written by Hassan
<div id="signup">
<div id="signup-st">
<div align="center">
<?php
...
<div id="reg-bottom" class="btmrg">Copyright &copy; 2020 jangomart.com</div>
</div>
</div>
<div id="login">
<div id="login-st">
...
<div id="footer"><p> Copyright &copy; 2020-2025 jangomart.com </p></div>
</body>
</html>
